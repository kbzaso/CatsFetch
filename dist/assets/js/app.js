...
var $botonGato = document.getElementById('botonGato');
...
function load() {
  fetch('https://api.thecatapi.com/v1/images/search?').then(function (res) {
    ...
    var url = res[0].url;
    $imagenGato.innerHTML = "<img src=\"".concat(url, "\"  alt=\"\">");
  });
}
...
module.exports = __webpack_require__(/*! /Users/janopio/Documents/Proyectos Platzi/Cats2/src/assets/js/app.js */"./src/assets/js/app.js");
